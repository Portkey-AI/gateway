...
describe('exa online handler', () => {
        ...
        request: {
          ...
          json: {
            messages: [
              ...
              { role: 'user', content: 'What are recent advances in AI?' },
            ],
          },
        },
      }
  ...
  it('should filter results using excludeDomains parameter', async () => {
    const eventType = 'beforeRequestHook';
    const context = createChatCompleteRequestContext('Latest iPhone reviews');
  ...
  it('should handle invalid queries gracefully', async () => {
    const eventType = 'beforeRequestHook';
    const context = createChatCompleteRequestContext(''); // Empty query
