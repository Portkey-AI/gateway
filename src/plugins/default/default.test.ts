...
import { handler as requestParametersCheckHandler } from './requestParametersCheck';
...
// Set up the plugin helpers with mock options for tests that use the global post function
beforeAll(() => {
  setPluginHelpers(mockPluginHandlerOptions);
});
...
describe('Regex Matcher Plugin', () => {
  ...
  it('should handle long text by truncating excerpt', async () => {
    ...
    const longTextContext: PluginContext = {
      requestType: 'chatComplete',
      response: {
        json: {
...
describe('jsonSchema handler', () => {
  it('should validate JSON in response text', async () => {
    ...
    const result = await jsonSchemaHandler(
      context,
      parameters,
      eventType,
      mockPluginHandlerOptions
  ...
  it('should return a false verdict when schema does not match', async () => {
    const context = createChatCompleteResponseContext('{"key": "value"}');
    const eventType = 'afterRequestHook';
    const parameters: PluginParameters = {
      schema: {
        type: 'object',
...
And that's all the user information we have.`
  ...
  it('should fail validation for invalid nested JSON', async () => {
    const context = createChatCompleteResponseContext(
      `Let me show you the user profile with some invalid data:
\`\`\`json
{
  "user": {
    "name": "John Doe",
...
describe('jsonKeys handler', () => {
  ...
  it('should validate JSON with "any" operator and find match', async () => {
    ...
    const result = await jsonKeysHandler(
      context,
      parameters,
      mockEventType,
      mockPluginHandlerOptions
  ...
  it('should handle missing keys array', async () => {
    const context = createChatCompleteResponseContext('{"key1": "value1"}');
    const parameters: PluginParameters = {
      operator: 'any',
      not: false,
    };
...
describe('contains handler', () => {
  it('should return true verdict and correct data for any word in response text', async () => {
    ...
    const result = await containsHandler(
      context,
      parameters,
      eventType,
      mockPluginHandlerOptions
  ...
  it('should handle empty word list', async () => {
    const context = createChatCompleteResponseContext('some text');
    const eventType = 'afterRequestHook';
...
describe('validUrls handler', () => {
  ...
  it('should return true verdict for valid URLs in response text', async () => {
    const context = createChatCompleteResponseContext(
      'Check out https://example.com and https://google.com'
    );
    const parameters: PluginParameters = {
      onlyDNS: true,
      not: false,
    ...
    const result = await validUrlsHandler(
      context,
      parameters,
      mockEventType,
      mockPluginHandlerOptions
  ...
  it('should return false verdict for invalid URLs', async () => {
    const context = createChatCompleteResponseContext(
      'Check out https://invalid-domain-123456.com'
    );
    const parameters: PluginParameters = {
      onlyDNS: true,
      not: false,
  ...
  it('should handle malformed URLs', async () => {
    const context = createChatCompleteResponseContext(
      'Check out https://malformed.123 and http://this-is-definitely-invalid-12345.com/path?invalid=true#bad'
    );
    const parameters: PluginParameters = {
      onlyDNS: true,
      not: false,
  ...
  it('should handle URLs with query parameters and fragments', async () => {
    const context = createChatCompleteResponseContext(
      'Check out https://example.com/path?param=1#section'
    );
    const parameters: PluginParameters = {
      onlyDNS: true,
      not: false,
  ...
  it('should handle multiple URLs with mixed validity', async () => {
    const context = createChatCompleteResponseContext(
      'Valid: https://example.com Invalid: https://invalid-domain-123456.com'
    );
    const parameters: PluginParameters = {
      onlyDNS: true,
      not: false,
  ...
  it('should handle very long text with URLs', async () => {
    ...
    const context = createChatCompleteResponseContext(longText);
    const parameters: PluginParameters = {
      onlyDNS: true,
      not: false,
    };
...
describe('sentenceCount handler', () => {
  ...
  it('should return error for missing sentence count range', async () => {
    const context = createChatCompleteResponseContext('This is a sentence.');
    const parameters: PluginParameters = {};
...
describe('wordCount handler', () => {
  ...
  it('should handle invalid word count range', async () => {
    const context = createChatCompleteResponseContext('This is a test.');
    const parameters: PluginParameters = {
...
describe('allUppercase handler', () => {
  ...
  it('should return false verdict and data for mixed case text', async () => {
    const context = createChatCompleteResponseContext('This Has Mixed Case.');
  ...
  it('should handle text with only non-letter characters', async () => {
    const context = createChatCompleteResponseContext('123 !@#$%');
...
describe('characterCount handler', () => {
  ...
  it('should return false verdict and data for character count outside range', async () => {
    const context = createChatCompleteResponseContext(
      'This is a very long test that exceeds the limit.'
    );
    const parameters: PluginParameters = {
      minCharacters: 10,
      maxCharacters: 20,
...
describe('endsWith handler', () => {
  ...
  it('should return true verdict and data when text ends with suffix', async () => {
    const context = createChatCompleteResponseContext(
      'This is a test ending with HarryPortkey'
    );
    const parameters: PluginParameters = {
      suffix: 'HarryPortkey',
      not: false,
    ...
    const result = await endsWithHandler(
      context,
      parameters,
      mockEventType,
      mockPluginHandlerOptions
  ...
  it('should return false verdict and data when text does not end with suffix', async () => {
    const context = createChatCompleteResponseContext(
      'This is a test ending with something else'
    );
    const parameters: PluginParameters = {
      suffix: 'HarryPortkey',
      not: false,
...
describe('jwt handler', () => {
  ...
  it('should validate a valid JWT token', async () => {
    ...
    // This test uses a mock JWT that won't validate against Google's JWKS
    // so we expect it to fail with "No matching key found for kid"
    expect(result.verdict).toBe(false);
    expect(result.data).toMatchObject({
      verdict: false,
    });
  ...
  it('should handle invalid authorization header format', async () => {
    ...
    // The handler attempts to parse the token, which should fail
    expect(result.verdict).toBe(false);
  });
  ...
  it('should handle missing JWKS URI', async () => {
    ...
    expect(result.data).toMatchObject({
      verdict: false,
      explanation:
        'JWT validation error: Either jwks, jwksUri, or introspectEndpoint must be provided',
    });
  });
  ...
  it('should use custom header key from parameters', async () => {
    ...
    // This test uses a mock JWT that won't validate against Google's JWKS
    // Verify the custom header key is being read correctly by checking the token is processed
    expect(result.verdict).toBe(false);
    expect(result.data).toMatchObject({
      verdict: false,
    });
  ...
  it('should use environment variables when parameters not provided', async () => {
    ...
    // Without jwksUri, jwks, or introspectEndpoint, the handler should error
    const parameters: PluginParameters = {};
  ...
  it('should handle invalid JWKS URI', async () => {
    const context: PluginContext = {
      request: {
        headers: {
          Authorization:
            'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InRlc3Qta2V5In0.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c',
        },
      },
    };
    const parameters: PluginParameters = {
    ...
    // The handler will try to fetch from the invalid URI and fail
    expect(result.verdict).toBe(false);
  });
});
...
describe('addPrefix handler', () => {
  ...
  describe('Messages (Anthropic format)', () => {
    ...
    it('should prepend prefix block when content array has non-text first element', async () => {
      // Note: When using getCurrentContentPart/setCurrentContentPart with array content,
      // the text array is created from all items (including images with empty text).
      // The prefix is applied to the first textArray index (the image's text property).
      const context: PluginContext = {
        requestType: 'messages',
        request: {
          json: {
      ...
      expect(result.error).toBe(null);
      expect(result.transformed).toBe(true);
      // The prefix gets applied to the image element's text property (index 0 in textArray)
      expect(
        result.transformedData.request.json.messages[0].content[0].text
      ).toBe('Analyze carefully: ');
      // The original text element remains unchanged
      expect(
        result.transformedData.request.json.messages[0].content[1].text
...
describe('Request Parameters Check Plugin', () => {
  const mockEventType = 'beforeRequestHook';

  describe('Tools Configuration', () => {
    describe('blockedTypes', () => {
      it('should block tools with blocked type', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        const result = await requestParametersCheckHandler(
          context,
          parameters,
          mockEventType,
          mockPluginHandlerOptions
        ...
        expect(result.error).toBeNull();
        expect(result.verdict).toBe(false);
        expect(result.data.blockedToolsFound).toHaveLength(1);
        expect(result.data.blockedToolsFound[0].type).toBe('code_interpreter');
        expect(result.data.blockedToolsFound[0].reasons).toContain(
          'type_blocked'
        );
      });

      it('should allow tools when type is not blocked', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        expect(result.error).toBeNull();
        expect(result.verdict).toBe(true);
        expect(result.data.blockedToolsFound).toBeUndefined();
      });
    });

    describe('allowedTypes', () => {
      it('should block tools with type not in allowed list', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        expect(result.verdict).toBe(false);
        expect(result.data.blockedToolsFound).toHaveLength(1);
        expect(result.data.blockedToolsFound[0].type).toBe('web_search');
        expect(result.data.blockedToolsFound[0].reasons).toContain(
          'type_not_allowed'
        );
      });

      it('should allow tools when type is in allowed list', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
    ...
    describe('blockedFunctionNames', () => {
      it('should block tools with blocked function name', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        const parameters: PluginParameters = {
          tools: {
            blockedFunctionNames: ['execute_shell', 'delete_file'],
          },
        };
        ...
        expect(result.verdict).toBe(false);
        expect(result.data.blockedToolsFound).toHaveLength(1);
        expect(result.data.blockedToolsFound[0].name).toBe('execute_shell');
        expect(result.data.blockedToolsFound[0].reasons).toContain(
          'name_blocked'
        );
      });
    ...
    describe('allowedFunctionNames', () => {
      it('should block tools with function name not in allowed list', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        expect(result.verdict).toBe(false);
        expect(result.data.blockedToolsFound).toHaveLength(1);
        expect(result.data.blockedToolsFound[0].name).toBe('send_email');
        expect(result.data.blockedToolsFound[0].reasons).toContain(
          'name_not_allowed'
        );
      });
    ...
    describe('multiple tool reasons', () => {
      it('should capture all blocking reasons for a tool', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
              tools: [{ type: 'code_interpreter', name: 'execute_code' }],
            },
          },
        };
        const parameters: PluginParameters = {
          tools: {
            blockedTypes: ['code_interpreter'],
            blockedFunctionNames: ['execute_code'],
          },
        };
    ...
    describe('tools config conflicts', () => {
      it('should throw error when same type is in both blocked and allowed lists', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        expect(result.error).not.toBeNull();
        expect(result.data.explanation).toContain('Tools config conflict');
      });
    });
  });
  ...
  describe('Params Configuration', () => {
    describe('blockedKeys', () => {
      it('should block request with blocked parameter key', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        expect(result.error).toBeNull();
        expect(result.verdict).toBe(false);
        expect(result.data.blockedParamsFound).toHaveLength(1);
        expect(result.data.blockedParamsFound[0].param).toBe('stream');
        expect(result.data.blockedParamsFound[0].reasons).toContain(
          'key_blocked'
        );
      });

      it('should allow request when no blocked keys are present', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
    ...
    describe('allowedKeys', () => {
      it('should block request with key not in allowed list', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        const parameters: PluginParameters = {
          params: {
            allowedKeys: ['model', 'messages', 'temperature'],
          },
        };
        ...
        expect(result.verdict).toBe(false);
        expect(result.data.blockedParamsFound).toHaveLength(1);
        expect(result.data.blockedParamsFound[0].param).toBe('logprobs');
        expect(result.data.blockedParamsFound[0].reasons).toContain(
          'key_not_allowed'
        );
      });
    ...
    describe('values - blockedValues', () => {
      it('should block request with blocked parameter value', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4-turbo',
        ...
        const parameters: PluginParameters = {
          params: {
            values: {
              model: {
                blockedValues: ['gpt-4-turbo', 'gpt-4-32k'],
              },
            },
          },
        };
        ...
        expect(result.verdict).toBe(false);
        expect(result.data.blockedParamsFound).toHaveLength(1);
        expect(result.data.blockedParamsFound[0].param).toBe('model');
        expect(result.data.blockedParamsFound[0].value).toBe('gpt-4-turbo');
        expect(result.data.blockedParamsFound[0].reasons).toContain(
          'value_blocked'
        );
      });
    ...
    describe('values - allowedValues', () => {
      it('should block request with value not in allowed list', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        expect(result.verdict).toBe(false);
        expect(result.data.blockedParamsFound).toHaveLength(1);
        expect(result.data.blockedParamsFound[0].param).toBe('temperature');
        expect(result.data.blockedParamsFound[0].reasons).toContain(
          'value_not_allowed'
        );
      });

      it('should allow request with value in allowed list', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
      ...
      it('should handle boolean values correctly', async () => {
        ...
        expect(result.verdict).toBe(false);
        expect(result.data.blockedParamsFound[0].param).toBe('stream');
        expect(result.data.blockedParamsFound[0].value).toBe(false);
      });
    });

    describe('params config conflicts', () => {
      it('should throw error when same key is in both blocked and allowed lists', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        expect(result.error).not.toBeNull();
        expect(result.data.explanation).toContain('Params config conflict');
      });

      it('should throw error when same value is in both blocked and allowed lists', async () => {
        const context: PluginContext = {
          request: {
            json: {
              model: 'gpt-4',
        ...
        const parameters: PluginParameters = {
          params: {
            values: {
              model: {
                blockedValues: ['gpt-4'],
                allowedValues: ['gpt-4', 'gpt-3.5-turbo'],
              },
            },
          },
        };
  ...
  describe('Combined Tools and Params', () => {
    it('should check both tools and params in single request', async () => {
      const context: PluginContext = {
        request: {
          json: {
            model: 'gpt-4-turbo',
      ...
      expect(result.verdict).toBe(false);
      expect(result.data.blockedToolsFound).toHaveLength(1);
      expect(result.data.blockedParamsFound).toHaveLength(2);
      expect(result.data.explanation).toContain('Blocked tools');
      expect(result.data.explanation).toContain('Blocked params');
    });

    it('should pass when both tools and params are valid', async () => {
      const context: PluginContext = {
        request: {
          json: {
            model: 'gpt-4',
      ...
      expect(result.error).toBeNull();
      expect(result.verdict).toBe(true);
      expect(result.data.explanation).toBe('All checks passed.');
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing tools in request', async () => {
      const context: PluginContext = {
        request: {
          json: {
            model: 'gpt-4',
    ...
    it('should handle null/undefined arrays gracefully', async () => {
      ...
      const parameters: PluginParameters = {
        tools: {
          blockedTypes: null as any,
          allowedTypes: undefined,
        },
        params: {
          blockedKeys: null as any,
    ...
    it('should handle tool with name property instead of function.name', async () => {
      const context: PluginContext = {
        request: {
          json: {
            model: 'gpt-4',
      ...
      const parameters: PluginParameters = {
        tools: {
          blockedFunctionNames: ['web_search_tool'],
        },
      };
      ...
      expect(result.error).toBeNull();
      expect(result.verdict).toBe(false);
      expect(result.data.blockedToolsFound[0].name).toBe('web_search_tool');
    });

    it('should fallback to type as name when no name provided', async () => {
      const context: PluginContext = {
        request: {
          json: {
            model: 'gpt-4',
      ...
      const parameters: PluginParameters = {
        tools: {
          blockedFunctionNames: ['code_interpreter'],
        },
      };
      ...
      expect(result.error).toBeNull();
      expect(result.verdict).toBe(false);
      expect(result.data.blockedToolsFound[0].name).toBe('code_interpreter');
    });

    it('should reject afterRequestHook event type', async () => {
      const context: PluginContext = {
        request: {
          json: {
            model: 'gpt-4',
      ...
      expect(result.error).not.toBeNull();
      expect(result.error.message).toContain('before_request_hooks');
    });

    it('should return toolsInRequest in response data', async () => {
      const context: PluginContext = {
        request: {
          json: {
            model: 'gpt-4',
      ...
      const parameters: PluginParameters = {
        tools: {
          blockedFunctionNames: ['execute_shell'],
        },
      };
      ...
      expect(result.error).toBeNull();
      expect(result.verdict).toBe(true);
      expect(result.data.toolsInRequest).toHaveLength(2);
      expect(result.data.toolsInRequest[0]).toEqual({
        type: 'function',
        name: 'get_weather',
      });
      expect(result.data.toolsInRequest[1]).toEqual({
        type: 'function',
        name: 'search_web',
      });
    });
...
describe('Not Null Plugin', () => {
  ...
  it('should pass when response content exists', async () => {
    ...
    const result = await notNullHandler(
      context,
      parameters,
      mockEventType,
      mockPluginHandlerOptions
