...
export const handler: PluginHandler<{
  ...
  const url = `${credentials.customHost ? credentials.customHost : `https://${credentials.resourceName}.cognitiveservices.azure.com`}/contentsafety/text:analyze?api-version=${apiVersion}`;
