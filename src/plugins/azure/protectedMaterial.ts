...
export const handler = async (
  ...
  const url = `${credentials.customHost ? credentials.customHost : `https://${credentials.resourceName}.cognitiveservices.azure.com`}/contentsafety/text:detectProtectedMaterial?api-version=${apiVersion}`;
