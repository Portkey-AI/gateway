...
import { handler as portkeydataservice } from './portkey/dataservice';
...
import { handler as defaultRequestParametersCheck } from './default/requestParametersCheck';
import { handler as defaultinlineImageUrls } from './default/inlineImageUrls';
import { handler as f5GuardrailsScanHandler } from './f5-guardrails/scan';
...
import { handler as aktoScan } from '../../plugins/akto/scan';
...
export const plugins = {
  default: {
    ...
    requestParametersCheck: defaultRequestParametersCheck,
    notNull: defaultnotNull,
    inlineImageUrls: defaultinlineImageUrls,
  },
  qualifire: {
  ...
  portkey: {
    ...
    dataservice: portkeydataservice,
  },
  aporia: {
  ...
  'f5-guardrails': {
    scan: f5GuardrailsScanHandler,
  },
  'crowdstrike-aidr': {
    guardChatCompletions: crowdstrikeAidrHandler,
  },
  zscaler: {
