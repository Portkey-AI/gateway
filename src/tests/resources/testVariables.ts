...
const testVariables: TestVariables = {
  openai: {
    ...
    createSpeech: { model: 'tts-1', voice: 'alloy' },
    createTranscription: { model: 'whisper-1' },
    createTranslation: { model: 'whisper-1' },
  },
  cohere: {
  ...
  elevenlabs: {
    ...
    createSpeech: { model: 'eleven_multilingual_v2' },
    createTranscription: { model: 'scribe_v1' },
  },
  deepgram: {
    apiKey: process.env.DEEPGRAM_API_KEY,
    createSpeech: { model: 'aura-2-en-us' },
    createTranscription: { model: 'nova-2' },
  },
};
