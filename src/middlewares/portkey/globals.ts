...
export const HEADER_KEYS = {
  ...
  VIRTUAL_KEY_ID: 'x-portkey-virtual-key-id',
  VIRTUAL_KEY_DETAILS: 'x-portkey-virtual-key-details',
  INTEGRATION_RATE_LIMITS: 'x-portkey-integration-rate-limits',
  INTEGRATION_USAGE_LIMITS: 'x-portkey-integration-usage-limits',
  INTEGRATION_EXHAUSTED: 'x-portkey-integration-exhausted',
  INTEGRATION_ID: 'x-portkey-integration-id',
  INTEGRATION_SLUG: 'x-portkey-integration-slug',
  INTEGRATION_MODELS: 'x-portkey-integration-model-details',
...
export const INTERNAL_HEADER_KEYS: Record<string, string> = {
  CLIENT_AUTH_SECRET: 'x-client-auth-secret',
};
...
export const KV_PREFIX = {
  orgConfig: 'ORG_CONFIG_',
  cacheOrgProviderKeyPrefix: 'PROVIDER_KEY_V2_',
  promptPrefix: 'PROMPT_V2_',
  prompPartialPrefix: 'PROMPT_PARTIAL_',
  virtualKeyUsagePrefix: 'VK_USAGE_',
  guardrailPrefix: 'GUARDRAIL_',
  integrationPrefix: 'INTEGRATION_',
};
