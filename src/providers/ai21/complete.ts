...
export const AI21CompleteResponseTransform: (response: AI21CompleteResponse, responseStatus: number) => CompletionResponse | ErrorResponse = (response, responseStatus) => {
