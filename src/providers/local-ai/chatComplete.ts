...
export const LocalAIChatCompleteConfig: ProviderConfig = {
  model: {
    param: 'model',
    required: true,
    default: 'local',
...
export interface LocalAIChatCompleteResponse extends ChatCompletionResponse {
  system_fingerprint: string;
}

export const LocalAIErrorResponseTransform: (
...
export const LocalAIChatCompleteResponseTransform: (
  response: LocalAIChatCompleteResponse | ErrorResponse,
 ...
 */
export const LocalAIChatCompleteJSONToStreamResponseTransform: (
  response: LocalAIChatCompleteResponse,
  provider: string
