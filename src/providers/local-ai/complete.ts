...
export const LocalAICompleteConfig: ProviderConfig = {
  model: {
    param: 'model',
    required: true,
    default: 'local',
...
export interface LocalAICompleteResponse extends CompletionResponse {
  system_fingerprint: string;
}

export const LocalAICompleteResponseTransform: (
  response: LocalAICompleteResponse | ErrorResponse,
 ...
 */
export const LocalAICompleteJSONToStreamResponseTransform: (
  response: LocalAICompleteResponse,
  provider: string
