...
describe('Vertex AI Media Resolution Support', () => {
  ...
  describe('Config integration', () => {
    it('should have media_resolution in VertexGoogleChatCompleteConfig', () => {
      expect(VertexGoogleChatCompleteConfig).toHaveProperty('media_resolution');
      expect(VertexGoogleChatCompleteConfig.media_resolution).toEqual({
