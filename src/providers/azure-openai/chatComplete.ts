...
export const AzureOpenAIChatCompleteResponseTransform: (response: AzureOpenAIChatCompleteResponse | ErrorResponse, responseStatus: number) => ChatCompletionResponse | ErrorResponse = (response, responseStatus) => {
