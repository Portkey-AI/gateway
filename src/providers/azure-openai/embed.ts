...
export const AzureOpenAIEmbedResponseTransform: (response: AzureOpenAIEmbedResponse | ErrorResponse, responseStatus: number) => EmbedResponse | ErrorResponse = (response, responseStatus) => {
