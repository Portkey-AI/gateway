...
export const validate = async (projectID:string, credentials: any, data:any) => {
  const options = {
    headers: {
...
export const handler: PluginHandler = async (
  ...
  try {
    ...
    const result:any = await validate(parameters.projectID, parameters.credentials, aporiaObject);
